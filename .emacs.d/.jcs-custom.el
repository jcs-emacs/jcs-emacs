 ...
 '(tree-sitter-fold-range-alist
   `((c-mode \,
     ...
     (js3-mode \,
               (tree-sitter-fold-parsers-javascript))
     (json-mode \,
                (tree-sitter-fold-parsers-json))
     (jsonc-mode \,
                 (tree-sitter-fold-parsers-json))
     (nix-mode \,
               (tree-sitter-fold-parsers-nix))
     (python-mode \,
                  (tree-sitter-fold-parsers-python))
     (rjsx-mode \,
                (tree-sitter-fold-parsers-javascript))
     (ruby-mode \,
                (tree-sitter-fold-parsers-ruby))
     (rust-mode \,
                (tree-sitter-fold-parsers-rust))
     (rustic-mode \,
                  (tree-sitter-fold-parsers-rust))
     (typescript-mode \,
                      (tree-sitter-fold-parsers-typescript)))))
