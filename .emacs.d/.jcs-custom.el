(custom-set-variables
 ...
 '(package-selected-packages
   '(shift-select reload-emacs multi-shell jayces-mode file-header emoji-github lsp-java lsp-origami buffer-wrap manage-minor-mode-table magit masm-mode quelpa company-quickhelp-terminal company-emoji emojify ffmpeg-player flycheck command-log-mode lsp-treemacs flycheck-popup-tip flycheck-pos-tip flycheck-grammarly neotree vs-dark-theme vs-light-theme undo-tree lsp-mode company-lsp dap-mode lsp-ui manage-minor-mode tabulated-list-wrap pfuture swiper define-it lua-mode lv counsel-projectile smex counsel ivy parse-it treemacs pos-tip hydra emms dash-functional julia-mode reveal-in-folder websocket edit-indirect elisp-def request wiki-summary projectile visual-regexp kotlin-mode dockerfile-mode package-lint vue-mode ess diminish-buffer markdown-toc browse-kill-ring org-bullets ht company-fuzzy flx go-mode feebleline line-reminder indicators centaur-tabs highlight-indent-guides use-ttf alt-codes preproc-font-lock gdscript-mode rainbow-mode haxe-mode dumb-jump ssass-mode region-occurrences-highlighter yascroll esup swift-mode dart-mode basic-mode google-this right-click-context show-eol csharp-mode isearch-project async hl-todo page-break-lines goto-char-preview elixir-mode erlang multiple-cursors buffer-move dashboard glsl-mode company-quickhelp origami yasnippet-snippets dash git-commit move-text cmake-font-lock restart-emacs focus goto-line-preview transient with-editor ini-mode htmltagwrap auto-rename-tag cobol-mode rust-mode yaml-mode markdown-mode nhexl-mode clojure-mode javadoc-lookup typescript-mode yasnippet xcscope wgrep-ag wgrep vimrc-mode sql-indent simple-httpd scss-mode s popup pkg-info json-snatcher json-reformat htmlize google-translate f epl emmet-mode diminish cmake-mode bind-key avy ace-window js2-mode company apache-mode which-key web-mode use-package tree-mode togetherly shader-mode scala-mode python-mode project-abbrev processing-mode powerline package-build organize-imports-java nasm-mode json-mode impatient-mode iedit haskell-mode gitignore-mode gitconfig-mode gitattributes-mode exec-path-from-shell com-css-sort auto-highlight-symbol ag adaptive-wrap actionscript-mode))
