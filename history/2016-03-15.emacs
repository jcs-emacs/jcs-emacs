...
;;------------------------------------------------------------------------------------------------------
;; jcs key binding
(global-set-key (kbd "C-d") 'kill-whole-line) ; Sets `C-c d` to `M-x kill-whole-line`
...
(defun jcs_setup-php()
  ...
  (setq web-mode-ac-sources-alist
	'(("css" . (ac-sources-words-in-buffer ac-source-css-property))
	  ("html" . (ac-source-words-in-buffer ac-source-abbrev))
	  ("php" . (ac-source-words-in-buffer
		    ac-source-words-in-same-mode-buffers
		    ac-source-dictionary))))
  )
(add-to-list 'auto-mode-alist '("\\.php$" . jcs-setup-php))
