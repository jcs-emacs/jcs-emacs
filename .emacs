...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elixir-mode erlang multiple-cursors helm-projectile projectile buffer-move beacon dashboard flycheck-popup-tip glsl-mode company-quickhelp origami line-reminder polymode yasnippet-snippets dash git-commit move-text cmake-font-lock restart-emacs web-server indicators focus dimmer goto-line-preview transient magit with-editor right-click-context ini-mode htmltagwrap auto-rename-tag indent-info cobol-mode swift-mode rust-mode yaml-mode hydra markdown-mode markdown-preview-mode nhexl-mode sr-speedbar clojure-mode undo-tree tabbar javadoc-lookup typescript-mode haxe-mode yasnippet xcscope wgrep-helm wgrep-ag wgrep websocket vimrc-mode tablist sql-indent skewer-mode simple-httpd scss-mode s request-deferred request popup pkg-info pcache memoize levenshtein json-snatcher json-reformat htmlize highlight-indentation highlight helm-core helm-ag google-translate google-this google-maps git-messenger fringe-helper flycheck f epl emmet-mode diminish deferred cmake-mode bind-key avy ace-window pyvenv magit-popup js2-mode ghub helm company apache-mode xwidgete which-key web-mode visual-regexp use-ttf use-package tree-mode togetherly sublimity ssass-mode shader-mode scala-mode rainbow-mode python-mode project-abbrev processing-mode preproc-font-lock powerline pdf-tools package-lint package-build organize-imports-java nasm-mode lua-mode json-mode impatient-mode iedit helm-gtags haskell-mode go-mode gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-link floobits exec-path-from-shell csharp-mode cpputils-cmake com-css-sort cmake-project cmake-ide better-defaults basic-mode auto-package-update auto-highlight-symbol all-the-icons ag adaptive-wrap actionscript-mode)))
