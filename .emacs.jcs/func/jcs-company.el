...
(cl-defun jcs-company-set-face
  ...
  (add-to-list 'company-box-doc-frame-parameters `(background-color . ,(car quickhelp)))
  (add-to-list 'company-box-doc-frame-parameters `(foreground-color . ,(cdr quickhelp))))
